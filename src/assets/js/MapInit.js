...
import { wmsUrl, offlineUrl } from '../../network/env.js'
...
export function defaultInitCesium(id, mapType, isImage, sceneModeType = '3D', options = null, completionByDefaultOptions, ) {
    ...
    if (mapType == 'ArcGIS') {
        ...
        imageryProvider = getOfflineProvider();
    }
    ...
    viewer.camera.setView({
        destination: Cesium.Cartesian3.fromDegrees(104.435314, 39.960521, 4000000.0),
    });
    if (mapType != "baidu") {
...
function getOfflineProvider() {
    return new Cesium.UrlTemplateImageryProvider({
        // url: "http://10.3.11.237:8080/map/{z}/{x}/{y}.png"
        url: offlineUrl
    });
}
